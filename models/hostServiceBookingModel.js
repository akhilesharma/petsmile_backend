...
const hostServiceBookingSchema = mongoose.Schema({
    host:{
...
{
    strict: true,
    collection: 'hostServiceBooking',
    versionKey: false
});

exports.HostServiceBookingModel = mongoose.model('hostServiceBooking', hostServiceBookingSchema)